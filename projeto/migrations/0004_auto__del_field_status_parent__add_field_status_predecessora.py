...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Status.parent'
        db.delete_column('projeto_status', 'parent_id')

        # Adding field 'Status.predecessora'
        db.add_column('projeto_status', 'predecessora',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projeto.Status'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Status.parent'
        db.add_column('projeto_status', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projeto.Status'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Deleting field 'Status.predecessora'
        db.delete_column('projeto_status', 'predecessora_id')
