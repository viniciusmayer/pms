...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Pessoa.area'
        db.delete_column('projeto_pessoa', 'area_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Pessoa.area'
        db.add_column('projeto_pessoa', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='area_pessoa', to=orm['projeto.Area']),
                      keep_default=False)
    ...
    models = {
        ...
        'projeto.fato': {
            ...
            'ativo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 15, 0, 0)'}),
            'data_hora_atualizacao': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'data_hora_criacao': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'excluido': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'projeto.iteracao': {
            ...
            'ativo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'data_fim': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 27, 0, 0)'}),
            'data_hora_atualizacao': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'data_hora_criacao': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'data_inicio': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 15, 0, 0)'}),
            'excluido': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
